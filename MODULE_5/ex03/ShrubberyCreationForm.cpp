...
ShrubberyCreationForm::ShrubberyCreationForm():AForm("none", 145, 137),target("none")
{
...
ShrubberyCreationForm::ShrubberyCreationForm(const ShrubberyCreationForm& rhs):AForm("shrubbery creation", 145, 137),target(rhs.target)
{
